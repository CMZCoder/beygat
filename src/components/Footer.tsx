            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="mt-12 pt-8 border-t border-bronze-800/50 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        <a href="https://www.instagram.com/cris_kalel/" target="_blank" rel="noopener noreferrer" className="text-bronze-500 hover:text-omnis-glow transition-all hover:scale-110">
                        ...
                        <a href="https://www.youtube.com/@criskalel5521" target="_blank" rel="noopener noreferrer" className="text-bronze-500 hover:text-omnis-glow transition-all hover:scale-110">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
