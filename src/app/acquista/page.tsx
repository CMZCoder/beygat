...
export const metadata: Metadata = {
    ...
    description: "Acquista Le Cronache di Beygat: Fuga dal Regno Centrale in formato Kindle o Paperback.",
};
        ...
        <div className="pt-24 pb-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="card group hover:border-omnis-glow/50 transition-all duration-500 text-center">
                            <div className="w-20 h-20 rounded-full bg-omnis-glow/20 flex items-center justify-center mx-auto mb-6 group-hover:bg-omnis-glow/30 transition-colors">
                                <svg className="w-10 h-10 text-omnis-glow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                            </div>
                            <h2 className="text-2xl font-semibold text-bronze-100 mb-2">Kindle eBook</h2>
                            <p className="text-bronze-400 text-sm mb-4">Formato digitale per tutti i dispositivi</p>

                            <div className="mb-6">
                                <span className="text-4xl font-bold text-omnis-glow">€3.99</span>
                            </div>

                            <ul className="text-left text-bronze-400 text-sm space-y-2 mb-8">
                                <li className="flex items-center gap-2">
                                    <svg className="w-4 h-4 text-omnis-glow flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="card group hover:border-bronze-500/50 transition-all duration-500 text-center">
                            <div className="w-20 h-20 rounded-full bg-bronze-600/20 flex items-center justify-center mx-auto mb-6 group-hover:bg-bronze-600/30 transition-colors">
                                <svg className="w-10 h-10 text-bronze-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                                </svg>
                            </div>
                            <h2 className="text-2xl font-semibold text-bronze-100 mb-2">Paperback</h2>
                            <p className="text-bronze-400 text-sm mb-4">Edizione cartacea da collezione</p>

                            <div className="mb-6">
                                <span className="text-4xl font-bold text-bronze-300">€14.99</span>
                            </div>
            ...
            <section className="py-16 px-6 bg-bronze-900/30">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-semibold text-bronze-100 mb-8 text-center">Dettagli del Libro</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between border-b border-bronze-700/50 pb-2">
                                ...
                                <span className="text-bronze-200">Le Cronache di Beygat #1</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-2xl font-semibold text-bronze-100 mb-8">Cosa Dicono i Lettori</h2>

                    <div className="card">
                        <div className="flex justify-center mb-4">
                            {[1, 2, 3, 4, 5].map((star) => (
                                <svg key={star} className="w-6 h-6 text-omnis-lemon" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                            ))}
                        </div>
                        <blockquote className="text-lg text-bronze-200 italic mb-4">
                            «Un esordio travolgente. Non vedevo l'ora di scoprire cosa sarebbe successo dopo.
                            Il mondo dell'Omnis è affascinante e i personaggi sono indimenticabili.»
                        </blockquote>
